...
import mlflow.sklearn, mlflow, os, argparse, pandas as pd, numpy as np 
...
def main(alpha, l1_ratio):
    ...
    with mlflow.start_run(): 
        ...
        rmse, mae, r2 = evaluate(test_y, prediction)
        ...
        mlflow.sklearn.log_model(lr, "model") # artifact model name!
